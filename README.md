...
| **ACTION**                         | Действие по умолчанию для выполнения _(0/1/2)_<br/>'0' для запроса действия от пользователя каждый раз<br/>'1' для создания сеанса<br/>'2' для запуска кликера                  |
